...
calc_valences()
{
  ...
  // Implement something here
	mesh_.add_property(valenceArray);
	...
	{
		valence = 0;
		/* Iterate over vertices in 1-ring neighbourhood */
		...
		mesh_.property(valenceArray, v_it) = valence;
	}
  /////////////////////////////////////////////////////////////////////////////
}
...
color_coding()
{
  ...
  // Implement something here
	...
	for(v_it =  mesh_.vertices_begin(); v_it != v_end; ++v_it)
	{
		/* Retrive the valence of each vertex*/
		valence = mesh_.property(valenceArray,v_it);
		
		/* Set the color coding */
		if(valence < 5) 
			mesh_.set_color(v_it, Mesh::Color(0,255,255));
		else if(valence < 7) 
			mesh_.set_color(v_it, Mesh::Color(0,0,255));
		else if(valence < 9) 
			mesh_.set_color(v_it, Mesh::Color(0,255,0));
		else if(valence < 12) 
			mesh_.set_color(v_it, Mesh::Color(255,255,0));
		else if(valence < 16)
			mesh_.set_color(v_it, Mesh::Color(0,127,0));
		else if(valence < 20)
			mesh_.set_color(v_it, Mesh::Color(127,0,127));
		else
			mesh_.set_color(v_it, Mesh::Color(255,0,0));
	}
