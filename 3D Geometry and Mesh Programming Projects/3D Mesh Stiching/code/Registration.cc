...
)
{
  ...
  for(int i = 0; i < (int) _src.size(); i++)
  {
	...
	////////////////////////////////////////////////////////////////////////////
	  ...
	  Vector3d diff = ( _target[i] - _src[i] );
	  A[i*18+0] = 0;			A[i*18+1] = _src[i][2];		A[i*18+2] = -_src[i][1];
	  A[i*18+3] = 1;			A[i*18+4] = 0;				A[i*18+5] = 0;
	  A[i*18+6] = -_src[i][2];	A[i*18+7] = 0;				A[i*18+8] = _src[i][0];
	  A[i*18+9] = 0;			A[i*18+10] = 1;				A[i*18+11] = 0;
	  A[i*18+12] = _src[i][1];	A[i*18+13] = -_src[i][0];	A[i*18+14] = 0;
	  A[i*18+15] = 0;			A[i*18+16] = 0;				A[i*18+17] = 1;
...
)
{
  ...
  for(int i = 0; i < (int) _src.size(); i++)
  {
	...
	////////////////////////////////////////////////////////////////////////////
	  ...
	  A[i * 6 + 5] = _target_normals[i][2];

	  Vector3d diff = (_src[i] - _target[i]);
	  b[i] = -dot_product(diff,_target_normals[i]); 
